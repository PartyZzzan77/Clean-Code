...
var createNewTaskElement=function(taskString){
  ...
  var uniqElemString=taskString.split(' ').join('-');
  ...
  editInput.id=uniqElemString
  editInput.ariaLabel=uniqElemString;


  editButton.innerText='Edit'; //innerText encodes special characters, HTML does not.
  editButton.classList.add('button', 'button_edit');
  editButton.ariaLabel='button edit task';

  deleteButton.classList.add('button', 'button_delete');
  deleteButton.ariaLabel='button delete task';
  deleteButtonImg.src='./src/assets/svg/remove.svg';
  deleteButtonImg.className = 'button__ico';
...
var editTask=function(){
  ...
  var containsClass=listItem.classList.contains('tasks-box__item_editable');
  //If class of the parent is .tasks-box__item_editable
  if(containsClass){

  //switch to .tasks-box__item_editable
  ...
  //toggle .tasks-box__item_editable on the parent.
  listItem.classList.toggle('tasks-box__item_editable');
};
